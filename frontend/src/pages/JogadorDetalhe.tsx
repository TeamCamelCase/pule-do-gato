...
export default function JogadorDetalhe() {
  ...
  // Mock de dados do jogador (Estilo do Figma)
  const jogador = {
    nome: "HULK",
    time: "Atlético-MG",
    idade: 37,
    ...
    altura: "1.80 m",
    posicao: "Atacante",
    foto: "https://images.unsplash.com/photo-1511886929837-354d827aae26?q=80&w=1000&auto=format&fit=crop", // Placeholder de estádio escuro/jogador
    stats: {
      xg: "0.85",
      chutes_alvo: "2.5",
      conversao: "32%",
    ...
    insight_ia: "A IA detecta uma taxa de conversão altíssima do Hulk nos últimos 15 minutos de jogo. O cansaço da zaga adversária cria o cenário perfeito para finalizações de fora da área."
  };

  useEffect(() => {
    // Simulando o tempo de busca na API
